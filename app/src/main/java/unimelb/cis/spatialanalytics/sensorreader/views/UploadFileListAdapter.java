 ...
 * code reference from
 */
public class UploadFileListAdapter extends BaseExpandableListAdapter {
        ...
        if (FileListManager.getFileCollections().get(FileListManager.getFolderList().get(groupPosition)).size() > 0)
            upload.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    new UploadFileToServer( context, textViewError, expListView,  UploadFileListAdapter.this,groupPosition);
